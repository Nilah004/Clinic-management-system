...
<head>
    ...
    <title>Past Patient History - MediTrackPro</title>
...
<body>
<div class="container">
    <a href="doctorDashboard.jsp" class="button back-button">
    ...
    <% if (completedList != null && !completedList.isEmpty()) { %>
        <table>
            ...
            <tbody>
                ...
                %>
                <tr>
                    <td data-label="Patient Name"><%= appt.getPatientName() %></td>
                    <td data-label="Date"><%= dateFormatter.format(appt.getAppointmentDate()) %></td>
                    <td data-label="Time"><%= timeFormatter.format(appt.getAppointmentTime()) %></td>
                    <td data-label="Status"><%= appt.getStatus() %></td>
                </tr>
                <% } %>
            </tbody>
        </table>
    <% } else { %>
        <p class="no-history-message">No completed appointments found.</p>
    <% } %>
</div>
</body>
</html>
